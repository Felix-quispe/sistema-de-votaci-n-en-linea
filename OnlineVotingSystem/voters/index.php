            ...
            <?php 
                ...
                ?>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th colspan="4" class="bg-green text-white"><h5> TEMA ELECTORAL: <?php echo strtoupper($election_topic); ?></h5></th>
                                </tr>
                                <tr>
                                    <th> Foto </th>
                                    <th> Detalles del candidato </th>
                                    <th> # de votos </th>
                                    <th> Acción </th>
                                </tr>
                            </thead>
                            ...
                            ?>
                                    ...
                                    ?>
                                                <button class="btn btn-md btn-success" onclick="CastVote(<?php echo $election_id; ?>, <?php echo $candidate_id; ?>, <?php echo $_SESSION['user_id']; ?>)"> Votar </button>
                                    <?php
                                            }
