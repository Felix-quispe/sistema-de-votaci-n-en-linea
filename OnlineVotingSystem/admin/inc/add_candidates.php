...
?>
        <div class="alert alert-success my-3" role="alert">
         El candidato ha sido añadido con éxito.
        </div>
<?php 
    }else if(isset($_GET['largeFile'])) {
?>
        <div class="alert alert-danger my-3" role="alert">
         La imagen candidata es demasiado grande, cargue un archivo pequeño (puede cargar cualquier imagen de hasta 2 MB).
        </div>
<?php
...
?>
        <div class="alert alert-danger my-3" role="alert">
         Tipo de imagen no válido (solo se permiten archivos .jpg, .png).
        </div>
<?php
...
<div class="row my-3">
    <div class="col-4">
        <h3>Agregar nuevos candidatos</h3>
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <select class="form-control" name="election_id" required> 
                    ...
                    ?>
                            <option value=""> Por favor agregue la elección primero </option>
                    <?php
                        }
                    ?>
                </select>
    ...
    <div class="col-8">
        ...
        <table class="table">
            ...
            ?>
                        <tr> 
                            <td colspan="7"> No se ha agregado ningún candidato todavía. </td>
                        </tr>
            <?php
                    }
                ?>
