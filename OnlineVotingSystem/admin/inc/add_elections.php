...
?>
        <div class="alert alert-success my-3" role="alert">
         La elección se ha agregado correctamente.
        </div>
<?php 
...
?>
       <div class="alert alert-danger my-3" role="alert">
         ¡La elección se ha eliminado correctamente!
        </div>
<?php
                ...
                ?>
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <button class="btn btn-sm btn-danger" onclick="DeleteData(<?php echo $election_id; ?>)"> Borrar </button>
                                </td>
                            </tr>
                <?php
                        }
