...
<html>
<head>
	<title>Iniciar sesión - Sistema de votación en línea</title>
			...
			<div class="user_card">
                ...
                ?>
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="su_username" class="form-control input_user" placeholder="nombre" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                                    </div>
                                    <input type="text" name="su_contact_no" class="form-control input_pass" placeholder="dni" required />
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                                    </div>
                                    <input type="password" name="su_password" class="form-control input_pass" placeholder="contraseña" required />
                                </div>     
                                <div class="input-group mb-2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                                    </div>
                                    <input type="password" name="su_retype_password" class="form-control input_pass" placeholder="Repetir contraseña" required />
                                </div>
                                
                                    <div class="d-flex justify-content-center mt-3 login_container">
                            <button type="submit" name="sign_up_btn" class="btn login_btn">Inscribirse</button>
                        </div>
                            </form>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            ¿Ya has creado una cuenta? <a href="index.php" class="ml-2 text-white">Iniciar sesión</a>
                            </div>
                        </div>
                <?php
                    }else {
                ?>
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <div class="d-flex justify-content-center mt-3 login_container">
                            <button type="submit" name="loginBtn" class="btn login_btn">Acceso</button>
                        </div>
                            </form>   
                        </div>
                        ...
                        <div class="mt-4">
                            <div class="d-flex justify-content-center links text-white">
                              ¿No tienes una cuenta? <a href="?sign-up=1" class="ml-2 text-white">Inscribirse</a>
                            </div>
                ...
                <?php 
                    ...
                    {
                ?>
                        <span class="bg-white text-success text-center my-3"> ¡Su cuenta ha sido creada con éxito! </span>
                <?php
                    }else if(isset($_GET['invalid'])) {
                ?>
                        <span class="bg-white text-danger text-center my-3">  Las contraseñas no coinciden, ¡inténtalo de nuevo! </span>
                <?php
                    }else if(isset($_GET['not_registered'])) {
                ?>
                        <span class="bg-white text-warning text-center my-3"> Lo sentimos, no estas registrado </span>
                <?php
                    }else if(isset($_GET['invalid_access'])) {
                ?>
                        <span class="bg-white text-danger text-center my-3">  ¡Usuario o contraseña invalido! </span>
                <?php
                    }
                ?>
